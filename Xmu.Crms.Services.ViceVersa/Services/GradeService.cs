...
{
    [StatelessWorker]
    internal class GradeService : Orleans.Grain, IGradeService
    {
        ...
        public Task<SeminarGroup> GetSeminarGroupBySeminarGroupIdAsync(long seminarGroupId) =>
            _iGradeDao.GetSeminarGroupBySeminarGroupIdAsync(seminarGroupId);
        ...
        public Task UpdateGroupByGroupIdAsync(long seminarGroupId, int grade) =>
            _iGradeDao.UpdateGroupByGroupIdAsync(seminarGroupId, grade);
