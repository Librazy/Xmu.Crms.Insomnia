...
namespace Xmu.Crms.Insomnia
{
    public static class Utils
    {
        ...
        public static Type Type(this ClaimsPrincipal user) =>
            Enum.Parse<Type>(user.Claims.Single(c => c.Type == "type").Value, true);
    ...
    public class ShouldSerializeContractResolver : DefaultContractResolver
    {
        ...
        public ShouldSerializeContractResolver(HashSet<string> ignored,
            SortedDictionary<HashSet<string>, ShouldSerializeContractResolver> ins)
        {
