...
namespace Xmu.Crms.Shared.Models
{
    public class SeminarGroup
    {
        ...
        [Column("seminar_id")] public long SeminarId { get; set; }

        [ForeignKey("SeminarId")] public Seminar Seminar { get; set; }

        [Column("class_id")] public long ClassId { get; set; }

        [ForeignKey("ClassId")] public ClassInfo ClassInfo { get; set; }
        ...
        [Column("leader_id")] public long LeaderId { get; set; }

        [ForeignKey("LeaderId")] public UserInfo Leader { get; set; }
