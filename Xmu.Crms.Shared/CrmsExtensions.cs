...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class CrmsExtensions
    {
        ...
        {
            var startConfig =
                serviceCollection.SingleOrDefault(s => s.ServiceType == typeof(CrmsStartupConfig))
                    ?.ImplementationInstance as CrmsStartupConfig ?? new CrmsStartupConfig();
        ...
        public static IServiceCollection UseCrmsSqlite(this IServiceCollection serviceCollection,
